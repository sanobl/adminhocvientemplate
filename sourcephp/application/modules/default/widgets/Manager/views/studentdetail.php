                                ...
                                <fieldset>
                                    ...
                                    <h5>
                                        ...
                                        <a class="pull-right" onclick="btn_print_new(<?php
                                           echo '\'' . $listbill[0]['student_fullname'] . '\',\''. $listbill[0]['student_id']. '\',\'' . $listbill[0]['title']. '\',\'' . $listbill[0]['subject_id']  . '\',\'' . $listbill[0]['money'] . '\',\'' . Core_Utilities::convert_number_to_words($listbill[0]['money']) . '\'';
                                           ?>);">In Mới</a>
                                    </h5>
                                    <table id="print_bill">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            for ($i = 0; $i < count($listbill); $i++) {
                                                ...
                                                <tr>
                                                    <td><?php echo $stt ?></td>
                                                    <td><?php echo $listbill[$i]['bill_code'] ?></td>
                                                    <td><?php echo $listbill[$i]['student_fullname'] ?></td>
                                                    <td><?php echo $listbill[$i]['created_by'] ?></td>
                                                    <td><?php
                                                $timetmp = strtotime($listbill[$i]['created_at']);
                                                $timetmp = date('d/m/Y h:m:i', $timetmp);
                                                echo $timetmp;
                                                ?></td>
                                                    <td><?php echo $listbill[$i]['money'] ?></td>
                                                    <td><a href="javascript:void(0);" onClick="btn_print_action(<?php
                                                echo '\'' . $listbill[$i]['bill_code'] . '\',\'' . $listbill[$i]['student_fullname'] . '\',\'' . $listbill[$i]['created_by'] . '\',\'' . $listbill[$i]['title'] . '\',\'' . $listbill[$i]['money'] . '\',\'' . Core_Utilities::convert_number_to_words($listbill[$i]['money']) . '\'';
                                                ?>);">  <i class="splashy-printer" style="padding-right:7px"></i></a></td>
                                                </tr>
                            <?php } ?>
                                        </tbody>
                                    </table>
                ...
                <page size="A5" layout="portrait">
                    ...
                    <div style="display: table; width: 100%; height: 23px;">
                        ...
                        <span  style="display: table-cell;border-bottom: 1px #000 dotted;vertical-align: bottom;" >
                            <input type="text" value="" class="student_fullname" style="border: none;box-shadow: none;padding: 1px;margin-bottom: 0px;width: 100%;">
                        </span>
                        <span  style="display: table-cell; width: 10px; "></span>
                    </div>
                    ...
                    <div style="display: table; width: 100%;height: 23px;">
                        <span  style="display: table-cell; width: 70px; vertical-align: bottom;">Nội dung thu :</span>
                        <span  style="display: table-cell;border-bottom: 1px #000 dotted;vertical-align: bottom;" >
                            <input type="text" value="" id="subjectname" style="border: none;box-shadow: none;padding: 1px;margin-bottom: 0px;width: 100%;">
                        </span>
                        <span  style="display: table-cell; width: 10px; "></span>
                    </div>
                    <div style="display: table; width: 100%;height: 23px;">
                        <span  style="display: table-cell; width: 60px; vertical-align: bottom;">Số tiền thu :</span>
                        <span  style="display: table-cell;width: 250px; border-bottom: 1px #000 dotted; text-align: center;vertical-align: bottom;" id="money_total">

                        </span>
                        <span style="display: table-cell; width: 80px; vertical-align: bottom;">(Viết bằng chữ)</span>
                        <span  style="display: table-cell;border-bottom: 1px #000 dotted; vertical-align: bottom;text-align: center" id="money_convert">
...
<script>
    ...
    function btn_print_action(billcode, student_fullname, created_by, subjecttitle, money, moneyconvert) {
        ...
        $('#money_total').html(money + ' đồng');
        $('#money_convert').html(moneyconvert);
