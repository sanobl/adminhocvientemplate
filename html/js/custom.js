...
gebo_mask_input = {
    init: function() {
        $("#thongkethang").inputmask("99/9999",{placeholder:"mm/yyyy"});
        $("#thongkenam").inputmask("9999",{placeholder:"yyyy"});
        $("#thongketuychinhtu").inputmask("99/99/9999",{placeholder:"dd/mm/yyyy"});
        $("#thongketuychinhden").inputmask("99/99/9999",{placeholder:"dd/mm/yyyy"});
...
gebo_datepicker = {
    init: function() {
        ...
        $('#dp_from_start').datepicker({
            ...
            $('#dp_to_start').datepicker('setStartDate', dateText);
        ...
        $('#dp_to_start').datepicker({
            ...
            $('#dp_from_start').datepicker('setEndDate', dateText);
            $('#dp_to_start').datepicker('hide');
        });
